...
$string['wantassertionssigned_help'] = '';
$string['assertionsconsumerservices'] = 'Assertions Consumer Services';
$string['assertionsconsumerservices_help'] = '';
$string['entityid'] = 'Entity ID';
$string['entityid_help'] = '';
$string['allowcreate'] = 'Allow Create';
$string['allowcreate_help'] = '';
$string['matchnameid'] = 'Match on NameID value';
$string['matchnameid_help'] = '';
